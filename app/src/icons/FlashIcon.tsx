...
export const FlashIconOn = () => (
  <Svg width={18} height={24} fill="none">
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M13.877.102a.75.75 0 01.34.87L11.515 9.75H16.5a.75.75 0 01.546 1.264l-12 12.75a.75.75 0 01-1.263-.735l2.701-8.779H1.5a.75.75 0 01-.546-1.264l12-12.75A.75.75 0 0113.876.1v.001z"
      fill="#fff"
    />
  </Svg>
);
